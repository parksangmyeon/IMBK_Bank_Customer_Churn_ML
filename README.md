...
- 상품 수 역시 중요한 변수로 나타났으며, 상품을 많이 이용할 수록 고객 이탈율이 높아지는 것을 확인할 수 있습니다.
- 따라서 상품 수가 많은 고객군에 대해서는 현재 보유 상품 구성이 실제 고객 수요와 맞는지 점검하고, 불필요하거나 복잡한 상품 조합은 없는지 확인할 필요가 있습니다.
